	...
	<div id="default-carousel" className="relative" data-carousel="static">
        ...
        <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
            ...
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <Image src="https://flowbite.com/docs/images/carousel/carousel-1.svg" width={800} height={800}  alt="alt" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"  />
            </div>

            <div className="hidden duration-700 ease-in-out" data-carousel-item>
                <Image src="https://flowbite.com/docs/images/carousel/carousel-2.svg"  width={800} height={800} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
            </div>

            <div className="hidden duration-700 ease-in-out" data-carousel-item>
                <Image src="https://flowbite.com/docs/images/carousel/carousel-3.svg"  width={800} height={800} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
            </div>
        </div>
