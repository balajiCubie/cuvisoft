    ...
    <footer className="bg-gray-800  text-white  ">
      <div className="max-w-7xl mx-auto pt-4 sm:pt-6 lg:pt-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h5 className="text-lg font-semibold mb-4">Learn About AWS</h5>
            <ul>
              <li className="mb-2"><a href="#" className="hover:underline">What Is AWS?</a></li>
              <li className="mb-2"><a href="#" className="hover:underline">What Is Cloud Computing?</a></li>
              <li className="mb-2"><a href="#" className="hover:underline">AWS Accessibility</a></li>
              <li className="mb-2"><a href="#" className="hover:underline">AWS Inclusion, Diversity & Equity</a></li>
              ...
              <li className="mb-2"><a href="#" className="hover:underline">AWS Cloud Security</a></li>
          ...
          <div>
            <h5 className="text-lg font-semibold mb-4">Resources for AWS</h5>
            <ul>
              ...
              <li className="mb-2"><a href="#" className="hover:underline">AWS Solutions Library</a></li>
              ...
              <li className="mb-2"><a href="#" className="hover:underline">AWS Partners</a></li>
            </ul>
          </div>
          <div>
            <h5 className="text-lg font-semibold mb-4">Developers on AWS</h5>
            <ul>
          ...
          <div>
            ...
            <ul>
              ...
              <li className="mb-2"><a href="#" className="hover:underline">AWS re:Post</a></li>
              ...
              <li className="mb-2"><a href="#" className="hover:underline">AWS Careers</a></li>
            </ul>
          </div>
        </div>
      ...
      <div className="text-center mt-5 p-3 px-5 text-black bg-slate-200">
            ...
            <p className="mt-4">&copy; 2024, Amazon Web Services, Inc. or its affiliates. All rights reserved.</p>
        </div>
    </footer>
  );
}
