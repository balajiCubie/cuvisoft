          ...
          <div className=" flex ">
            <div className=" ">
              <div className=" w-full">
                ...
                <TabContent
                  details=" Amazon Bedrock is a fully managed service offering a choice of high-performing FMs from leading AI companies and Amazon through a unified API, along with a broad set of capabilities to build and scale generative AI applications. As a serverless service, Amazon Bedrock requires no infrastructure management while allowing secure integration and deployment using familiar AWS services.
                ...
                />
                <TabContent
                  details=" The rapid growth of generative AI brings promising new innovation and, at the same time, raises new challenges. At AWS, we are committed to responsibly developing AI, taking a people-centric approach that prioritizes education, science, and our customers. Integrate responsible AI across the complete AI lifecycle with services and tools like Guardrails for Amazon Bedrock, Amazon SageMaker Clarify, AWS AI service cards, and many more.
                  The rapid growth of generative AI brings promising new innovation and, at the same time, raises new challenges. At AWS, we are committed to responsibly developing AI, taking a people-centric approach that prioritizes education, science, and our customers. Integrate responsible AI across the complete AI lifecycle with services and tools like Guardrails for Amazon Bedrock, Amazon SageMaker Clarify, AWS AI service cards, and many more.
                  The rapid growth of generative AI brings promising new innovation and, at the same time, raises new challenges. At AWS, we are committed to responsibly developing AI, taking a people-centric approach that prioritizes education, science, and our customers. Integrate responsible AI across the complete AI lifecycle with services and tools like Guardrails for Amazon Bedrock, Amazon SageMaker Clarify, AWS AI service cards, and many more. "
                  tabCategory="about"
                ...
                />
                <TabContent
                  details="Amazon Q also makes it easier for employees to get answers to questions across business data—such as company policies, product information, business results, code base, employees, and many other topics. Amazon Q connects to enterprise data repositories to logically summarize the data, analyze trends, and engage in dialogue about the data.
